...
class TestAuto1111Client:
    ...
    def test_get_upscalers_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/upscalers", timeout=30
        )
    ...
    def test_get_models_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/sd-models", timeout=30
        )
    ...
    def test_get_samplers_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/samplers", timeout=30
        )
    ...
    def test_get_schedulers_success(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = [{"name": "Automatic", "label": "Automatic"}]
        mock_get.return_value = mock_response
        ...
        mock_get.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/schedulers", timeout=30
        )
    ...
    def test_get_progress_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            "progress": 0.5,
            "eta_relative": 30.0,
            "state": {"job": "Processing", "job_timestamp": "20231201120000"},
        }
        mock_get.return_value = mock_response
        ...
        mock_get.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/progress", timeout=10
        )
    ...
    def test_interrupt_success(self, mock_post):
        ...
        mock_post.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/interrupt", timeout=10
        )
    ...
    def test_img2img_success(self, mock_post):
        ...
        payload = {"init_images": ["base64_input"], "prompt": "test prompt"}
        ...
        mock_post.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/img2img", json=payload, timeout=30
        )
    ...
    def test_extra_single_image_success(self, mock_post):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"image": "base64_result"}
        mock_post.return_value = mock_response

        payload = {"image": "base64_input", "upscaling_resize": 2.0}
    ...
    def test_health_check_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "http://test.local:7860/sdapi/v1/memory", timeout=10
        )
