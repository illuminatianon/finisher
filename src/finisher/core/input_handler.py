...
class InputHandler:
    ...
    def __init__(self):
        ...
        self.on_image_received: Optional[Callable[[str, str], None]] = (
            None  # (source, path_or_data)
        )
    ...
    def _save_temp_image(self, image: Image.Image, source: str) -> Optional[str]:
        ...
        try:
            ...
            temp_fd, temp_path = tempfile.mkstemp(
                suffix=suffix, prefix=prefix, dir=docs_temp_dir
            )
    ...
    def _check_clipboard(self) -> None:
        ...
        try:
            ...
            if (
                ...
                and isinstance(current_content, Image.Image)
...
class DragDropHandler:
    ...
    def __init__(self, widget, input_handler: InputHandler):
        ...
        """
        logger.warning(
            "DragDropHandler is deprecated. PySide6 uses native "
            "drag-and-drop in ImageDropArea."
        )
        self.widget = widget
        self.input_handler = input_handler
